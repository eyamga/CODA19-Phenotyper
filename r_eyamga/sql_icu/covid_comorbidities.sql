...
WHERE
	...
	WHERE datetime(diagnosis_time) < datetime(episodes_covid_wholestay.episode_start_time, '-30 day') -- making sure that comorbidities are from at least > 30 days since the COVID admission
