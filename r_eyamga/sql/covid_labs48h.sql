...
FROM
	...
	-- Can modulate time here to make sure the lab occured at a specific time from the onset of hospitalization i.e. first 48 hours
WHERE
	datetime (lab_sample_time) BETWEEN datetime (covidepisodes.episode_start_time, '-24 hour') 
	AND datetime (covidepisodes.episode_start_time, '+48 hour')
)
