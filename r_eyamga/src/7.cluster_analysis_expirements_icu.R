...
#                             "lymph_min", "mono_max", "baso_min", "eos_min", "sodium_mean", "potassium_mean", "chloride_mean", "creatinine_mean",
#                             "bun_mean","magnesium_mean", "phosphate_mean", "glucose_mean", "ptt_max", "alt_max", "ast_max", "bili_tot_max", "ck_max",
#                             "albumin_mean", "lactate_max", "svo2sat_mean", "paco2_mean",  
#                             "fio2_mean", "so2_min", "temp_mean", "patient_age",
...
coda19 <- coda19%>%select(c("patient_site_uid","patient_age", "hemoglobin_min", "plt_max", "wbc_mean", "neutrophil_mean", 
                            ...
                            "albumin_mean", "lactate_max", "svo2sat_mean", "paco2_mean",  
                            "fio2_mean", "so2_min", "temp_mean", "patient_age", "neuromuscular_blocking_agents", 
                            "anticholesteremic_agents",
                            "male", "bronchodilator_agents", "antihypertensive_agents",
